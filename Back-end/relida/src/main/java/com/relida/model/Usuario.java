...
public class Usuario {
	...
	//Construtores
		...
		public Usuario(String nome, String email, String senha, PerguntaDeSeguranca pergunta_seg, String resposta_seg) {
			super();
			this.nome = nome;
			this.email = email;
			this.senha = senha;
	...
	@OneToOne
	private PerguntaDeSeguranca pergunta_seg;
	...
	public PerguntaDeSeguranca getPergunta_seg() {
		return pergunta_seg;
	}

	public void setPergunta_seg(PerguntaDeSeguranca pergunta_seg) {
		this.pergunta_seg = pergunta_seg;
	}
